...
# Page configuration
st.set_page_config(
    page_title="SmartStock ARIMA Forecasting",
    layout="wide",
...
# Fixed Footer
# Fixed Footer (Updated)
st.markdown("""
    <div class="footer">
        <div>Powered by SmartStock | © 2025 Akshitha Sai Maddukuri</div>
        <div class="footer-icons">
            <a href="https://github.com/Akshitha-524" target="_blank">
